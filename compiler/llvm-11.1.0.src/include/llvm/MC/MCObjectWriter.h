...
public:
  //DBL
  virtual uint64_t tell() { llvm_unreachable("Only implemented in ELFSingleObjectWriter"); }
  virtual void clear() { llvm_unreachable("Only implemented in ELFSingleObjectWriter"); }
